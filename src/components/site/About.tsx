...
const eventDetails = [
  {
    ...
    iconBoxClass:
      "border-amber-500/30 bg-amber-500/10 group-hover:border-amber-400/70 group-hover:bg-amber-500/20 group-hover:shadow-[0_0_20px_rgba(245,158,11,0.4)]",
    cardBorderHover:
      "hover:border-amber-400/50 hover:shadow-[0_0_30px_rgba(245,158,11,0.25)]",
  ...
  },
  {
    ...
    iconBoxClass:
      "border-orange-500/30 bg-orange-500/10 group-hover:border-orange-400/70 group-hover:bg-orange-500/20 group-hover:shadow-[0_0_20px_rgba(249,115,22,0.4)]",
    cardBorderHover:
      "hover:border-orange-400/50 hover:shadow-[0_0_30px_rgba(249,115,22,0.25)]",
    titleHover: "group-hover:text-orange-300",
    spotlight:
      "bg-gradient-to-b from-orange-400/15 via-transparent to-transparent",
  ...
  },
  {
    ...
    iconBoxClass:
      "border-cyan-500/30 bg-cyan-500/10 group-hover:border-cyan-400/70 group-hover:bg-cyan-500/20 group-hover:shadow-[0_0_20px_rgba(6,182,212,0.4)]",
    cardBorderHover:
      "hover:border-cyan-400/50 hover:shadow-[0_0_30px_rgba(6,182,212,0.25)]",
    titleHover: "group-hover:text-cyan-300",
    spotlight:
      "bg-gradient-to-b from-cyan-400/15 via-transparent to-transparent",
  ...
  },
  {
    ...
    iconBoxClass:
      "border-rose-500/30 bg-rose-500/10 group-hover:border-rose-400/70 group-hover:bg-rose-500/20 group-hover:shadow-[0_0_20px_rgba(244,63,94,0.4)]",
    cardBorderHover:
      "hover:border-rose-400/50 hover:shadow-[0_0_30px_rgba(244,63,94,0.25)]",
  ...
  },
  {
    ...
    iconBoxClass:
      "border-purple-500/30 bg-purple-500/10 group-hover:border-purple-400/70 group-hover:bg-purple-500/20 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.4)]",
    cardBorderHover:
      "hover:border-purple-400/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.25)]",
    titleHover: "group-hover:text-purple-300",
    spotlight:
      "bg-gradient-to-b from-purple-400/15 via-transparent to-transparent",
            ...
            return (
              <Reveal key={it.label} delay={i * 0.07}>
                ...
                >
                  ...
                  <div
                    className={`pointer-events-none absolute -inset-px rounded-2xl ${it.spotlight} opacity-0 transition-opacity duration-300 group-hover:opacity-100`}
                  />

                  {/* Corner sparkle */}
                  <Sparkles
                    className={`absolute top-3.5 right-3.5 h-4 w-4 ${it.sparkleColor} opacity-0 transition-opacity duration-300 group-hover:opacity-100 animate-pulse`}
                  />

                  <div>
                    <div className="flex items-center justify-between">
                      <div
                        className={`flex h-11 w-11 items-center justify-center rounded-xl border shadow-inner transition-all duration-300 group-hover:scale-110 ${it.iconBoxClass}`}
                      >
                        <Icon
                          aria-hidden="true"
                          strokeWidth={1.8}
                    ...
                    <h4
                      className={`mt-4 font-display text-sm sm:text-base lg:text-[1.05rem] font-black tracking-tight text-white transition-colors duration-200 uppercase leading-snug ${it.titleHover}`}
                    >
                      {it.value}
                    </h4>
