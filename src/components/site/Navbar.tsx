      ...
      <div className="flex h-15 sm:h-18 w-full items-center justify-between gap-1.5 px-2.5 sm:px-10 lg:px-14">
        <div className="flex items-center gap-1.5 sm:gap-5 min-w-0">
          <a
            ...
            className="font-display text-[0.85rem] sm:text-xl font-black tracking-[0.1em] sm:tracking-[0.16em] whitespace-nowrap shrink-0 bg-gradient-to-r from-foreground via-amber-200 to-ember bg-clip-text text-transparent drop-shadow-sm"
          >
            {event.name}
          </a>
